 ...
 */
public class SettingsPessoaisActivity extends AppCompatPreferenceActivity {
    ...
    private void setupActionBar() {
        ...
        getLayoutInflater().inflate(R.layout.app_bar_settings, (ViewGroup)findViewById(android.R.id.content));
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), SettingsPessoaisActivity.class));
                return true;
            }
